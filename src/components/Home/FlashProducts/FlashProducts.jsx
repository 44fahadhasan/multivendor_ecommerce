const FlashProducts = () => {
  return (
    <>
      ...
      <div class="p-1 mt-3 flex flex-wrap items-center justify-center">
        <div class="flex-shrink-0 m-6 relative overflow-hidden bg-orange-500 rounded-lg max-w-xs shadow-lg">
          <svg
            class="absolute bottom-0 left-0 mb-8 scale-150 opacity-10"
            viewBox="0 0 375 283"
            fill="none"
          >
            <rect
          ...
          <div class="relative pt-10 px-10 flex items-center justify-center">
            <div
              class="block absolute w-48 h-48 bottom-0 left-0 -mb-24 ml-3 scale-150 opacity-10"
        ...
        <div class="flex-shrink-0 m-6 relative overflow-hidden bg-slate-500 rounded-lg max-w-xs shadow-lg">
          <svg
            class="absolute bottom-0 left-0 mb-8 scale-150 opacity-10"
            viewBox="0 0 375 283"
            fill="none"
