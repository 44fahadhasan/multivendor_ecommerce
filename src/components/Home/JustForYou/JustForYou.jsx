const JustForYou = () => {
  return (
    <>
      <div className="text-center pt-24 container mx-auto">
        <h1 className="font-bold text-4xl mb-4 text-center">Just For You</h1>
      </div>

      <section className="pt-10 grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-14  mb-5">
