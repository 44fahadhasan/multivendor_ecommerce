  ...
  return (
    <header className="flex shadow-sm bg-white font-[sans-serif] min-h-[70px]">
      <div className="flex flex-wrap items-center justify-between sm:px-10 px-6 py-3 relative lg:gap-y-4 gap-y-6 gap-x-4 w-full">
        <div className="flex">
          ...
          <a className="ml-8">
            <h2 className="text-2xl font-black text-black">
              <span className="text-[#3B82F6]">Multi</span>Vendor
            </h2>
          </a>
        </div>

        <div className="bg-gray-100 flex border-2  max-md:order-1 border-transparent focus-within:border-blue-500 focus-within:bg-transparent px-4 rounded-full h-11 lg:w-2/4 max-md:w-full">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div>
          <ul className="flex items-center gap-x-10">
            <li>
              <a className="hover:text-[#007bff] text-[#007bff] font-semibold block text-[15px]">
                Home
              </a>
            </li>
      ...
      <div
        className={`${
          toggle ? "hidden" : "block"
        } before:fixed before:bg-black before:opacity-40 before:inset-0 max-lg:before:z-50`}
      >
        <button
        ...
        <ul className="block space-x-4 space-y-3 fixed bg-white w-1/2 min-w-[300px] top-0 left-0 p-4 h-full shadow-md overflow-auto z-50">
          ...
          <li className="border-b py-3 px-3">
            <a className="hover:text-[#007bff] text-[#007bff] block font-semibold text-base">
              Home
            </a>
          </li>
          <li className="border-b py-3 px-3">
            <a className="hover:text-[#007bff] text-black block font-semibold text-base">
              Team
            </a>
          </li>
          <li className="border-b py-3 px-3">
